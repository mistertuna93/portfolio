...
export const HomePage = () => {
    ...
    return (
        <div className="flex flex-col w-full h-full items-center justify-center animate-in fade-in duration-1000 p-2 md:p-4 overflow-y-auto no-scrollbar" style={{ fontFamily: "'DM Sans', sans-serif" }}>

            {/* MAIN CONTENT ROW (Column on Mobile) */}
            <div className="flex flex-col md:flex-row gap-3 min-h-0 flex-1 items-center justify-center w-full max-w-6xl mx-auto">
